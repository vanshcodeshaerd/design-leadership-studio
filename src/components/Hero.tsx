      ...
      <div className="container-padding relative z-10 text-center max-w-5xl mx-auto">
        <div className="reveal-fade">
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
            <span className="block">Tech Leadership</span>
            <span className="block text-gradient-primary">that Drives Innovation</span>
          </h1>
          
          <p className="text-xl sm:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto leading-relaxed">
            Senior Frontend Engineer & Product Designer with expertise in building 
            scalable solutions, growing high-performing teams, and leading product innovation.
          </p>
