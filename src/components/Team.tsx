  ...
  const teamMembers: TeamMember[] = [
    {
      ...
      fullBio: "Oversees community engagement, member relations, and fosters a welcoming environment for all tech enthusiasts. With 5+ years of community management experience, focuses on creating inclusive spaces where innovation thrives.",
    ...
    },
    {
      ...
      fullBio: "Leads technical workshops, hackathons, and coding competitions. Guides members in learning new technologies and maintains the club's technical standards. Expert in full-stack development and system architecture.",
      ...
      contact: {
        ...
        github: "github.com/tech-lead",
        linkedin: "linkedin.com/in/tech-lead"
      }
    },
    {
      id: "design-lead",
      ...
      fullBio: "Designs club branding, event materials, and digital assets. Ensures consistent visual identity across all club communications and platforms. Specializes in creating user-centered design solutions.",
      responsibilities: ["Brand Design", "UI/UX Design", "Design Systems", "Creative Direction"],
      achievements: ["Redesigned brand identity", "Improved user satisfaction by 60%", "Created comprehensive design system"],
    ...
    },
    {
      ...
      fullBio: "Manages social media platforms, creates engaging content, and builds online community. Handles digital marketing and online event promotion with expertise in content strategy and audience growth.",
    ...
    },
    {
      ...
      fullBio: "Develops partnerships with industry leaders, manages club recruitment, and coordinates outreach programs to expand our network. Expert in business development and strategic planning.",
    ...
    },
    {
      ...
      fullBio: "Leads marketing initiatives, brand communications, and public relations. Develops comprehensive marketing strategies to promote events, initiatives, and the organization's mission.",
      responsibilities: ["Marketing Strategy", "Brand Communications", "PR Management", "Campaign Development"],
      achievements: ["Launched 5 successful campaigns", "Increased brand awareness 250%", "Award-winning marketing campaign"],
