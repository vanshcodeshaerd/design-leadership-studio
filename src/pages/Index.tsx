  ...
  return <div className="min-h-screen">
      ...
      <section className="min-h-screen flex flex-col justify-center items-center relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="gradient-orb w-[600px] h-[600px] top-1/4 left-1/4" style={{
          background: 'radial-gradient(circle, hsl(260, 80%, 50%) 0%, transparent 70%)'
        }} />
          <div className="gradient-orb w-[500px] h-[500px] bottom-1/3 right-1/4" style={{
          background: 'radial-gradient(circle, hsl(240, 70%, 45%) 0%, transparent 70%)',
          animationDelay: '-5s'
        }} />
          <div className="gradient-orb w-[400px] h-[400px] top-1/2 right-1/3" style={{
        ...
        <div className="relative z-10 text-center container-padding pt-16 max-w-5xl mx-auto">
          ...
          <ParallaxSection delay={300}>
            <div className="flex flex-col sm:flex-row gap-3 justify-center mb-10">
              <Button className="btn-premium text-white px-6 py-5 text-sm font-medium rounded-xl group" asChild>
                <Link to="/about">
                  Discover More
                  <ArrowRight className="ml-2 h-4 w-4 transition-transform duration-300 ease-out group-hover:translate-x-1" />
                </Link>
              </Button>
              <Button className="btn-outline-glow px-6 py-5 text-sm font-medium rounded-xl text-foreground" asChild>
                <Link to="/team">
                  Meet The Team
                </Link>
              </Button>
      ...
      <section className="section-padding-sm relative overflow-hidden">
        <ParallaxSection className="container mx-auto container-padding">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {features.map((item, index) => <ParallaxSection key={index} delay={index * 80}>
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <div className="space-y-3">
                {[{
                icon: Sparkles,
                text: "Exclusive workshops and resources"
              }, {
                icon: Rocket,
              ...
              }].map((item, index) => <ParallaxSection key={index} delay={index * 100}>
            ...
            <ParallaxSection delay={200}>
              <div className="glass-card p-6 sm:p-8 rounded-2xl text-center">
                ...
                <Button className="btn-premium text-white px-6 py-4 text-sm font-medium rounded-xl w-full group" asChild>
                  <Link to="/join">
                    Get Started
                    <ArrowRight className="ml-2 h-4 w-4 transition-transform duration-300 ease-out group-hover:translate-x-1" />
                  </Link>
        ...
        <ParallaxSection className="container mx-auto container-padding">
          <div className="glass-card p-6 sm:p-8 rounded-2xl text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-sm text-muted-foreground mb-6 max-w-xl mx-auto">Join the NeoFolks community and be part of innovation and identity.</p>
